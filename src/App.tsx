...
import { GoalsPage, ReportsPage, SettingsPage } from "@/pages/admin-pages";
...
export function App() {
  ...
  const allowedPage = (() => {
    ...
    if (["metas", "relatorios", "configuracoes"].includes(activePage) && user?.role !== "gestor") return "dashboard";
    return activePage;
  })();
